  ...
  return(
    <div className={styles.container}>
      <div className={styles.box}>
        <Heading className={styles.heading} level="3" size="medium">{text.ingenSakerTittel[language]}</Heading>
        <ul>
          <li>Har du sendt inn en søknad per post tar det litt tid før saken vises her. Du kan likevel ettersende dokumenter.</li>
      ...
      <Button className={styles.button} variant="secondary">Gå til Min Side</Button>
    </div>
  );
};
